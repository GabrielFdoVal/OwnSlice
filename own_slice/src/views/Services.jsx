...
export default function Services() {
    return (
        <div>
            <Header></Header>
            <Navbar></Navbar>
            <Service title="Group Investment Facilitation" text="Assist groups of friends in coming together to invest in a property in Portugal and
            ...
            <Service title="Mortgage Assistance" text="Help groups secure financing by navigating the mortgage process in Portugal, work with banks to offer competitive mortgage 
